...
2. Follow [RAILWAY_GUIDE.md](./railway/RAILWAY_GUIDE.md) for deployment

### Having Issues?
- Check [Troubleshooting](./troubleshooting/) folder
- See [RAILWAY_GUIDE.md](./railway/RAILWAY_GUIDE.md) troubleshooting section

### Development
- [RUN_LOCALLY.md](./RUN_LOCALLY.md) - Local setup
- [ENVIRONMENT_VARIABLES.md](./ENVIRONMENT_VARIABLES.md) - Required variables
